...
public class PermissionGroup implements Serializable {
  ...
  /*
   * public PermissionGroup() { //groups = new ArrayList<>(); }
   *
  ...
  /*
   * public boolean isTrustedGroup(String group) { char level = group.charAt(0); if (level == (char) this.level) {
   * return true; } if (groups.contains(group)) { return true; } return false; }
   */
}
